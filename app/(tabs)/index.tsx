...
export default function HomeScreen() {
  ...
  const handleEmpezar = () => {
    const sueldo = Number(sueldoMensual);
    const presupuesto = Number(presupuestoDiario);
  ...
  const presupuestoDiarioNumero = Number(presupuestoDiario) || 0;
  const porcentajeGastado =
    presupuestoDiarioNumero > 0 ? Math.min((gastoTotal / presupuestoDiarioNumero) * 100, 100) : 0;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.progressWrapper}>
          <Text style={styles.progressLabel}>Presupuesto diario usado: {porcentajeGastado.toFixed(0)}%</Text>
          <View style={styles.progressTrack}>
            <View style={[styles.progressFill, { width: `${porcentajeGastado}%` }]} />
          </View>
        </View>
